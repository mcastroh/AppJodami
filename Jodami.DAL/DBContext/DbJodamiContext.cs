...
public partial class DbJodamiContext : DbContext
{
    ...
    public virtual DbSet<SocioContacto> SocioContacto { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCargo).HasName("PK__Cargo__6C98562506EC3D8C");

            entity.Property(e => e.IdCargo).HasComment("Cargo ID");
            entity.Property(e => e.Descripcion).HasComment("Descripción");
            entity.Property(e => e.EsActivo).HasComment("¿Es Activo?");
            entity.Property(e => e.FechaRegistro)
                .HasDefaultValueSql("(getdate())")
        ...
        modelBuilder.Entity<Socio>(entity =>
        {
            ...
            entity.Property(e => e.FechaRegistro)
                .HasDefaultValueSql("(getdate())")
                .HasComment("Auditoría Fecha");
            entity.Property(e => e.IdColaboradorAsignado).HasComment("Colaborador Asgnado ID");
        ...
        modelBuilder.Entity<SocioContacto>(entity =>
        {
            entity.HasKey(e => e.IdContacto).HasName("PK__SocioCon__A4D6BBFA84C8355E");

            entity.Property(e => e.IdContacto).HasComment("Contacto ID");
            entity.Property(e => e.Celular).HasComment("Celular");
            entity.Property(e => e.Email).HasComment("Email");
            entity.Property(e => e.EsActivo).HasComment("¿Es Activo?");
            entity.Property(e => e.FechaRegistro).HasComment("Auditoría Fecha");
            entity.Property(e => e.IdCargo).HasComment("Cargo ID");
            entity.Property(e => e.IdSocio).HasComment("Socio ID");
            entity.Property(e => e.IsCelularWhatsApp).HasComment("¿ Celular para Whats App ?");
            entity.Property(e => e.Nombre).HasComment("Nombres");
            entity.Property(e => e.Telefono).HasComment("Teléfono");
            entity.Property(e => e.UsuarioName).HasComment("Auditoría Usuario");

            entity.HasOne(d => d.IdCargoNavigation).WithMany(p => p.SocioContacto).HasConstraintName("FK_SocioContacto_Cargo");

            entity.HasOne(d => d.IdSocioNavigation).WithMany(p => p.SocioContacto)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_SocioContacto_Socio");
        });
