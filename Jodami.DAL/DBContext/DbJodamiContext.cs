...
public partial class DbJodamiContext : DbContext
{
    ...
    //public virtual DbSet<SocioCuentaBanco> SocioCuentaBancos { get; set; }

    //public virtual DbSet<SocioDireccion> SocioDireccions { get; set; }

    //public virtual DbSet<SocioFormaPago> SocioFormaPagos { get; set; }

    //public virtual DbSet<SocioPrecioArticulo> SocioPrecioArticulos { get; set; }

    //public virtual DbSet<SubGrupoArticulo> SubGrupoArticulos { get; set; }

    //public virtual DbSet<SubTipoMovimiento> SubTipoMovimientos { get; set; }

    //public virtual DbSet<SunatTipoDetraccion> SunatTipoDetraccions { get; set; }

    //public virtual DbSet<SunatTipoExistencium> SunatTipoExistencia { get; set; }

    //public virtual DbSet<Ticket> Tickets { get; set; }

    //public virtual DbSet<TicketLog> TicketLogs { get; set; }

    //public virtual DbSet<TicketPesaje> TicketPesajes { get; set; }
    ...
    //public virtual DbSet<TipoFlete> TipoFletes { get; set; }
    ...
    //    //    entity.HasOne(d => d.IdDireccionNavigation).WithMany(p => p.Almacens)
    //    //        .HasForeignKey(d => d.IdDireccion)
    //    //        .HasConstraintName("FK_Almacen_Direccion ");

    //    //    entity.HasOne(d => d.IdLocalNavigation).WithMany(p => p.Almacens)
    //    //        .HasForeignKey(d => d.IdLocal)
    //    //        .HasConstraintName("FK_Almacen_EmpresaLocal");

    //    //    entity.HasOne(d => d.IdResponsableNavigation).WithMany(p => p.Almacens)
    //    //        .HasForeignKey(d => d.IdResponsable)
    //    //        .HasConstraintName("FK_Almacen_Socio");

    //    //    entity.HasOne(d => d.IdTipoAlmacenNavigation).WithMany(p => p.Almacens)
    ...
    //    //    entity.HasOne(d => d.IdSubGrupoArticuloNavigation).WithMany(p => p.Articulos)
    ...
    //    //    entity.HasOne(d => d.IdTipoDetraccionNavigation).WithMany(p => p.Articulos)
    //    //        .HasForeignKey(d => d.IdTipoDetraccion)
    //    //        .HasConstraintName("FK_Articulo_SunatTipoDetraccion");

    //    //    entity.HasOne(d => d.IdTipoExistenciaNavigation).WithMany(p => p.Articulos)
    //    //        .HasForeignKey(d => d.IdTipoExistencia)
    //    //        .HasConstraintName("FK_Articulo_SunatTipoExistencia");

    //    //    entity.HasOne(d => d.IdTipoValorizacionNavigation).WithMany(p => p.Articulos)
    //    //        .HasForeignKey(d => d.IdTipoValorizacion)
    //    //        .HasConstraintName("FK_Articulo_TipoValorizacion");

    //    //    entity.HasOne(d => d.IdUnidadCompraNavigation).WithMany(p => p.ArticuloIdUnidadCompraNavigations)
    //    //        .HasForeignKey(d => d.IdUnidadCompra)
    //    //        .HasConstraintName("FK_Articulo_UnidadMedida1");

    //    //    entity.HasOne(d => d.IdUnidadInventarioNavigation).WithMany(p => p.ArticuloIdUnidadInventarioNavigations)
    //    //        .HasForeignKey(d => d.IdUnidadInventario)
    //    //        .HasConstraintName("FK_Articulo_UnidadMedida");

    //    //    entity.HasOne(d => d.IdUnidadVentaNavigation).WithMany(p => p.ArticuloIdUnidadVentaNavigations)
    ...
    //    //    entity.ToTable("EntidadFinanciera");
    ...
    //    //    entity.HasOne(d => d.IdTipoCalificacionNavigation).WithMany(p => p.Socios)
    //    //        .HasForeignKey(d => d.IdTipoCalificacion)
    //    //        .HasConstraintName("FK_Socio_TipoCalificacion");

    //    //    entity.HasOne(d => d.IdTipoDcmtoIdentidadNavigation).WithMany(p => p.Socios)
    //    //        .HasForeignKey(d => d.IdTipoDcmtoIdentidad)
    //    //        .OnDelete(DeleteBehavior.ClientSetNull)
    //    //        .HasConstraintName("FK_Socio_TipoDocumentoIdentidad");

    //    //    entity.HasOne(d => d.IdTipoMotivoBajaNavigation).WithMany(p => p.Socios)
    ...
    //    //    entity.ToTable("SocioCuentaBanco");
    ...
    //    //    entity.HasOne(d => d.IdEntidadFinancieraNavigation).WithMany(p => p.SocioCuentaBancos)
    //    //        .HasForeignKey(d => d.IdEntidadFinanciera)
    //    //        .OnDelete(DeleteBehavior.ClientSetNull)
    //    //        .HasConstraintName("FK_SocioCuentaBanco_EntidadFinanciera");

    //    //    entity.HasOne(d => d.IdMonedaNavigation).WithMany(p => p.SocioCuentaBancos)
    //    //        .HasForeignKey(d => d.IdMoneda)
    //    //        .OnDelete(DeleteBehavior.ClientSetNull)
    //    //        .HasConstraintName("FK_SocioCuentaBanco_Moneda");

    //    //    entity.HasOne(d => d.IdSocioNavigation).WithMany(p => p.SocioCuentaBancos)
    //    //        .HasForeignKey(d => d.IdSocio)
    //    //        .OnDelete(DeleteBehavior.ClientSetNull)
    //    //        .HasConstraintName("FK_SocioCuentaBanco_Socio");

    //    //    entity.HasOne(d => d.IdTipoCuentaBancariaNavigation).WithMany(p => p.SocioCuentaBancos)
    ...
    //    //    entity.HasOne(d => d.IdDireccionNavigation).WithOne(p => p.SocioDireccion)
    //    //        .HasForeignKey<SocioDireccion>(d => d.IdDireccion)
    //    //        .OnDelete(DeleteBehavior.ClientSetNull)
    //    //        .HasConstraintName("FK_SocioDireccion _Direccion ");

    //    //    entity.HasOne(d => d.Socio).WithMany(p => p.SocioDireccions)
    ...
    //    //    entity.HasOne(d => d.IdSocioNavigation).WithMany(p => p.SocioFormaPagos)
    //    //        .HasForeignKey(d => d.IdSocio)
    //    //        .OnDelete(DeleteBehavior.ClientSetNull)
    //    //        .HasConstraintName("FK_SocioFormaPago_Socio");

    //    //    entity.HasOne(d => d.IdTipoFormaPagoNavigation).WithMany(p => p.SocioFormaPagos)
    ...
    //    //    entity.ToTable("SocioPrecioArticulo");
    ...
    //    //    entity.HasOne(d => d.IdArticuloNavigation).WithMany(p => p.SocioPrecioArticulos)
    //    //        .HasForeignKey(d => d.IdArticulo)
    //    //        .OnDelete(DeleteBehavior.ClientSetNull)
    //    //        .HasConstraintName("FK_SocioPrecioArticulo_Articulo");

    //    //    entity.HasOne(d => d.IdMonedaNavigation).WithMany(p => p.SocioPrecioArticulos)
    //    //        .HasForeignKey(d => d.IdMoneda)
    //    //        .OnDelete(DeleteBehavior.ClientSetNull)
    //    //        .HasConstraintName("FK_SocioPrecioArticulo_Moneda");

    //    //    entity.HasOne(d => d.IdSocioNavigation).WithMany(p => p.SocioPrecioArticulos)
    //    //        .HasForeignKey(d => d.IdSocio)
    //    //        .OnDelete(DeleteBehavior.ClientSetNull)
    ...
    //    //    entity.ToTable("SubGrupoArticulo");
    ...
    //    //    entity.HasOne(d => d.IdGrupoArticuloNavigation).WithMany(p => p.SubGrupoArticulos)
    ...
    //    //    entity.ToTable("SubTipoMovimiento");
    ...
    //    //    entity.HasOne(d => d.IdTipoMovimientoNavigation).WithMany(p => p.SubTipoMovimientos)
    ...
    //    //    entity.ToTable("SunatTipoDetraccion");
    ...
    //    //modelBuilder.Entity<SunatTipoExistencium>(entity =>
    //    //{
    ...
    //    //    entity.HasOne(d => d.IdAlmacenDestinoNavigation).WithMany(p => p.TicketIdAlmacenDestinoNavigations)
    //    //        .HasForeignKey(d => d.IdAlmacenDestino)
    //    //        .HasConstraintName("FK_Ticket_Almacen1");

    //    //    entity.HasOne(d => d.IdAlmacenOrigenNavigation).WithMany(p => p.TicketIdAlmacenOrigenNavigations)
    //    //        .HasForeignKey(d => d.IdAlmacenOrigen)
    //    //        .HasConstraintName("FK_Ticket_Almacen");

    //    //    entity.HasOne(d => d.IdTipoMovimientoNavigation).WithMany(p => p.Tickets)
    //    //        .HasForeignKey(d => d.IdTipoMovimiento)
    ...
    //    //modelBuilder.Entity<TicketPesaje>(entity =>
    //    //{
