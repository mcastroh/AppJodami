...
{
    public class SunatTipoExistenciaController : Controller
    {
        ...
        public SunatTipoExistenciaController(IMapper mapper, IGenericService<TipoArticulo> service, IHttpContextAccessor httpContextAccessor)
        {
            _mapper = mapper;
            _service = service;
