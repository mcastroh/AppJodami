...
{
    public class NivelCentroCostoController : Controller
    {
        #region Variables 
        ...
        public NivelCentroCostoController(DbJodamiContext contexto, IGenericService<NivelCentroCosto> svrNivelCentroCosto, IHttpContextAccessor httpContextAccessor)
        {
            _contexto = contexto;
