...
namespace Jodami.AppWeb.Controllers
{
    public class EmpresaController : Controller
    {
        ...
        public EmpresaController(IMapper mapper, IHttpContextAccessor httpContextAccessor, DbJodamiContext contexto)
        {
            _mapper = mapper;
        ...
        public async Task<Empresa> ETL_Empresa()
        {
            var empresa = await _contexto.Empresa.AsNoTracking().FirstOrDefaultAsync();
