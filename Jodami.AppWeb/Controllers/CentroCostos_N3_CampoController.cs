...
{
    public class CentroCostos_N3_CampoController : Controller
    {
        #region Variables 
        ...
        public CentroCostos_N3_CampoController(DbJodamiContext contexto, IGenericService<CentroCosto> srvCentroCosto, IHttpContextAccessor httpContextAccessor, IMapper mapper)
        {
            _contexto = contexto;
