...
namespace Jodami.AppWeb.Controllers
{
    public class CentroCostos_N3_CampoController : Controller
    {
        ...
        public CentroCostos_N3_CampoController(DbJodamiContext contexto, IGenericService<CentroCosto> srvDB, IHttpContextAccessor httpContextAccessor, IMapper mapper)
        {
            _contexto = contexto;
            _srvDB = srvDB;
            _mapper = mapper;
